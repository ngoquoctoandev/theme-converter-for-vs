...
internal struct PkgDefItem
{
    ...
    public string[] ValueDataStringArray { get; set; }

    public byte[] ValueDataBinary { get; set; }

    public int ValueDataBinaryLength { get; set; }

    public uint ValueDataDWORD { get; set; }

    public ulong ValueDataQWORD { get; set; }
